...
{
    [SerializeField, TextArea(4,4)] private const string Explanation = "This is an singleton, It instantiate itself in the DontDestroyOnload " +
                                                  "and have different category's onces it gets turned to a dictionary " +
                                                  "all the categories got their own Prefixes [m_] [sfx_] [amb_] [ui_]"; 
    [System.Serializable]
    public class Sound
    {
